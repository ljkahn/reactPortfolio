  ...
  return (
    ...
    <Carousel className='position-absolute top-50 start-50 translate-middle carouselSize work'>
      <Carousel.Item>
        ...
        <img src={littleSiteOfHorrors} alt="Little Site of Horrors" className='img-fluid portfolio' /> </a>
        <Carousel.Caption>
          <h3>Little Site of Horrors</h3>
          <p>Full stack application horror movie database with profile feature.</p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p>
            Personal project for Austyn Cody Tattoos.
          </p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p>
            Quiz that tests your JavaScript knowledge.
          </p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p>
            Web application for retrieving weather data for cities around the world using third party API's.
          </p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
